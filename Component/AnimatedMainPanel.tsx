...
const createParticleElement = (
  ...
  el.className = "main-panel-particle";
  el.style.cssText = `
    position: absolute;
    width: 4px;
    height: 4px;
...
interface AnimatedMainPanelProps {
...
const AnimatedMainPanel = ({
  ...
  const animateParticles = useCallback(() => {
    if (!panelRef.current || !isHoveredRef.current) return;
  ...
  useEffect(() => {
    if (disableAnimations || !panelRef.current) return;
...
export default AnimatedMainPanel; 